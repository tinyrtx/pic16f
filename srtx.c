...
unsigned char SRTX_Timer_Cnt_Task1;
unsigned char SRTX_Timer_Cnt_Task2;
unsigned char SRTX_Timer_Cnt_Task3;
...
volatile unsigned char SRTX_Sched_Cnt_Task1;
volatile unsigned char SRTX_Sched_Cnt_Task2;
volatile unsigned char SRTX_Sched_Cnt_Task3;

// In cases of completing ADC, I2C, SIO in tasks, declare their task counters.

volatile unsigned char SRTX_Sched_Cnt_TaskADC;
volatile unsigned char SRTX_Sched_Cnt_TaskI2C;
volatile unsigned char SRTX_Sched_Cnt_TaskSIO;
...
// Clear all the task schedule counters.
    ...
    SUSR_Timer1_Expired();      // Set up initial timebase interrupt.
    ...
    while(1)
    {
        ...
        if( SRTX_Sched_Cnt_TaskI2C > 0 )        // If task has been scheduled..
        {
            ...
            {                                   // ..then provide a breakpoint location to trap it.
                asm("NOP");                     // Trap, task was scheduled again before done.
            }
