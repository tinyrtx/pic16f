...
//                  Created pic16 from pic18.
//
//  Overview: There are multiple projects coexisting in the pic16 directory.
...
1) Most files will remain common and untouched.
    ...
    d) All these file coexist in the single "tinyRTX pic16" directory,
...
3) Ensure project has correctly set the processor in the IDE:
    a) For example, if using the pic16f877:
        Configure/Select Device.../Device should be set to PIC16F877.
...
4) Ensure project has correctly set board selection in the MPASM macros:
    ...
    e) _UCFG_KA027C - Kairos Autonomi 027C: Pot and Encoder
...
8) Ensure the correct active toolsuite is set:
    ...
    Microchip XC8 Toolsuite:
        Microchip MPLAB XC8 Compiler: C:\Program Files\Microchip\xc8\v1.33\bin\xc8.exe
...
9) Ensure the project directories are set correctly:
    ...
    c) Project/Build Options.../Project/Directories/Include Search Path (Microchip C18 Toolsuite) = ""
    d) Project/Build Options.../Project/Directories/Library Search Path (Microchip C18 Toolsuite) = C:\Program Files\Microchip\mplabc18\v3.47\lib
    d) Project/Build Options.../Project/Directories/Library Search Path (Microchip MPASM Toolsuite) = ""
    e) Project/Build Options.../Project/Directories/Linker-Script Search Path = ""

(Microchip XC8 Toolsuite)
    a) Project/Build Options.../Project/Directories/Output Directory = output
    b) Project/Build Options.../Project/Directories/Include Search Path (Microchip XC8 Toolsuite) = ""
    c) Project/Build Options.../Project/Driver/Available drivers/MPLAB XC8 C Compiler V1.33
